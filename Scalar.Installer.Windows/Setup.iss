...
SetupIconFile="{#PayloadPath}\Images\scalar.ico"
...
[Files]
; Include all files (recursively) from the payload directory
DestDir: "{app}"; Flags: ignoreversion recursesubdirs; Source:"{#PayloadPath}\*";
