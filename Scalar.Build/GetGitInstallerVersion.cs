...
namespace Scalar.Build
{
    public class GetGitInstallerVersion : Task
    {
        ...
        {
            this.Log.LogMessage(MessageImportance.Normal, "Getting Git version from installer in package {0}/{1}...", this.PackageName, this.PackageVersion);

            string toolsPath = Path.Combine(this.NuGetPackageRoot, this.PackageName, this.PackageVersion, "tools");
